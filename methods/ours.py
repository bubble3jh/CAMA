"""BATCLIP baseline (Maharana et al., 2025).

The class name `OURS` and the registry key `ours` are inherited verbatim from
the upstream BATCLIP repository for reproducibility — this file implements the
**BATCLIP baseline**, not the proposed CAMA method. CAMA lives in `main_cama.py`
